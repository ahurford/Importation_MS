...
library(scales)
library(zoo)       #rolling percentage
library(viridis)
library(RColorBrewer)
library(mapcan)   #Canada map
...
## separate NL and SPM from Canadian
#IATA["ALLNL"] <- rowSums(IATA[, c("NL", "Saint.Pierre.and.Miquelon")])
#IATA["ALLCA"] <- IATA.CA$ALLCA
#IATA["ALLCANotNL"] <- IATA$ALLCA - IATA$ALLNL #subtract with-in travellers
